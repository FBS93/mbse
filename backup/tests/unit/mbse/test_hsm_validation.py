...
def test_validate_hsm_document_allows_local_initial_to_target_any_state():
  document = load_hsm_document(
    {
      "schema_version": "hsm-v1",
      "document_id": "cross_target_machine",
      "variables": [],
      "events": [],
  ...
  assert document.states[0].initial.target_id == "other"
