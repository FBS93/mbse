...
class HsmRuntime:
  ...
  def init(self) -> None:
    ...
    self._run_on_entry(target_id, executed_activities)
  ...
  def _descend_initial_chain(
    ...
    while current_state_id in self._generated_runtime.initial_target_ids:
      ...
      if initial_transition_id is not None:
        transition_ids.append(initial_transition_id)
      current_state_id = self._generated_runtime.initial_target_ids[current_state_id]
      self._run_on_entry(current_state_id, executed_activities)
